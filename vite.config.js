...
function toGatewayOrigin(target) {
...
function proxyGatewayUpgrade(req, downstreamSocket, downstreamHead, gatewayTarget) {
    ...
    upstreamReq.on("upgrade", (upstreamRes, upstreamSocket, upstreamHead) => {
        ...
        settled = true;
        downstreamSocket.write(serializeUpgradeResponse(upstreamRes.statusCode || 101, upstreamRes.statusMessage || "Switching Protocols", upstreamRes.headers));
